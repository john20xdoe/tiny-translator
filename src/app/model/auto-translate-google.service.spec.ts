...
describe('AutoTranslateGoogleService', () => {
  ...
  it('should be created', inject(
    [AutoTranslateGoogleService],
    (service: AutoTranslateGoogleService) => {
  ...
  it('should detect invalid key', async(
    inject(
      [AutoTranslateGoogleService],
      (service: AutoTranslateGoogleService) => {
        service.setApiKey('definitely_not_a_valid_key');
        service
          .canAutoTranslate('en', 'de')
          .pairwise()
          .subscribe(results => {
            expect(results[1]).toBeFalsy();
          });
        service
          .disabledReason('en', 'de')
          .pairwise()
          .subscribe(results => {
            expect(results[1].reason).toBe(
              AutoTranslateDisabledReasonKey.INVALID_KEY,
            );
          });
      },
    ),
  ...
  it('should support en and de', async(
    inject(
      [AutoTranslateGoogleService],
      (service: AutoTranslateGoogleService) => {
        service
  ...
  it('should not support fantasy language', async(
    inject(
      [AutoTranslateGoogleService],
      (service: AutoTranslateGoogleService) => {
        service
          .canAutoTranslate('en', 'fantasy')
          .pairwise()
          .subscribe(results => {
            expect(results[1]).toBeFalsy();
          });
        service
          .disabledReason('en', 'fantasy')
          .pairwise()
          .subscribe(results => {
            expect(results[1].reason).toBe(
              AutoTranslateDisabledReasonKey.TARGET_LANG_NOT_SUPPORTED,
            );
          });
      },
    ),
  ...
  it('should detect missing source language', async(
    inject(
      [AutoTranslateGoogleService],
      (service: AutoTranslateGoogleService) => {
        service
        ...
        service
          ...
          .subscribe(results => {
            expect(results[1].reason).toBe(
              AutoTranslateDisabledReasonKey.SOURCE_LANG_NOT_SUPPORTED,
            );
          });
      },
    ),
  ...
  it('should detect missing target language', async(
    inject(
      [AutoTranslateGoogleService],
      (service: AutoTranslateGoogleService) => {
        service
  ...
  it('should translate hello from english to german', async(
    inject(
      [AutoTranslateGoogleService],
      (service: AutoTranslateGoogleService) => {
  ...
  it('should translate hello from english to german ignoring region codes', async(
    inject(
      [AutoTranslateGoogleService],
      (service: AutoTranslateGoogleService) => {
  ...
  it('should translate multiple string at once', async(
    inject(
      [AutoTranslateGoogleService],
      (service: AutoTranslateGoogleService) => {
        service
          .translateMultipleStrings(['Hello', 'world'], 'en', 'de')
  ...
  it('should translate more than 128 multiple strings at once (exceeding google limit)', async(
    inject(
      [AutoTranslateGoogleService],
      (service: AutoTranslateGoogleService) => {
        ...
        service
          .translateMultipleStrings(manyMessages, 'en', 'de')
          .subscribe(translations => {
  ...
  it('should return a list of languages supported', async(
    inject(
      [AutoTranslateGoogleService],
      (service: AutoTranslateGoogleService) => {
        service
  ...
  it('should return a list of languages supported in german too', async(
    inject(
      [AutoTranslateGoogleService],
      (service: AutoTranslateGoogleService) => {
        service
